...
```
// java.lang.OutOfMemoryError: Failed to allocate a 7672332 byte allocation with 2811120 free bytes and 2MB until OOM
...
// 	at com.knirirr.beecount.WelcomeActivity.onSharedPreferenceChanged(WelcomeActivity.java:141)
