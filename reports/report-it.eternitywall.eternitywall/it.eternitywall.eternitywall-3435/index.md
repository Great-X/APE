title: it.eternitywall.eternitywall
...
```
// java.lang.NullPointerException: Attempt to invoke interface method 'boolean android.view.MenuItem.isActionViewExpanded()' on a null object reference
// 	at it.eternitywall.eternitywall.activity.MainActivity.onBackPressed(MainActivity.java:387)
